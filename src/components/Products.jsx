...
const ListView = ({ product }) => {
  const [mainImage, setMainImage] = useState(`https://chefdelightsfoods.com/static/products/${product.coverImage}`);
      ...
      <div className="w-full sm:w-2/3 sm:pl-6 text-left">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {product.subImages.map((img, index) => (
            ...
            onClick={() => setMainImage(`https://chefdelightsfoods.com/static/products/${img}`)}
            onError={(e) => {
