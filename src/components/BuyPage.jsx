...
const BuyPage = () => {
  ...
  useEffect(() => {
    ...
    if (stateProducts && Array.isArray(stateProducts)) {
      ...
      const fetchProduct = async () => {
        try {
          const response = await axios.get(`https://chefdelightsfoods.com/api/products/${productId}`);
          if (response.data) {
  ...
  const handlePayment = async () => {
    ...
    const orderResponse = await axios.post("https://chefdelightsfoods.com/api/payment/create-order/", {
    ...
    const options = {
      ...
      handler: async (response) => {
        ...
        const verifyRes = await axios.post("https://chefdelightsfoods.com/api/payment/verify-payment", {
          ...response,
          orderDetails: form,
          totalAmount,
          productIds,
